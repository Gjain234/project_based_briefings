...
```
project_based_briefings/
├── app.py                          # Flask application with both tools
├── app_shareable.py                # Shareable briefing-only Flask app
...
├── FCV Country News Sources.xlsx   # Curated local media guidance
│
# Cache, assets, and tests
├── intermediary_outputs/           # Cached briefing data
├── preprocessed_pads/              # Cached PAD extractions
├── rras/                           # RRA source texts
├── map_data/                       # Map overlays and project geodata
