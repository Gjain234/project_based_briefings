...
**IMPORTANT:** Include inline markdown hyperlinks in your summaries. Format as: `text ([Source Name](https://url.com))`. Use citations from your web search results.
...
{{{{
  "risks": [
    {{{{
      ...
      "summary": "string (2-4 sentences with inline markdown hyperlinks)",
      "themes": ["string"],
      "keywords": ["string"],
      "locations": ["string"],
...
Your task:
Assess where this project may be susceptible to implementation or outcome disruption given the current FCV dynamics.
...
IMPLEMENTATION_RISK_EXTRACTION_SYSTEM_PROMPT = """You are a World Bank FCV analyst reviewing a project implementation document.
...
RISK_MAPPING_SYSTEM_PROMPT = """You are a World Bank FCV analyst.
